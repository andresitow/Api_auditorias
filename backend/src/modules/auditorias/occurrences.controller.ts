...
import {
  evidenciaImagenMulterOptions,
  EVIDENCIAS_MAX_COUNT,
...
export class OccurrencesController {
  ...
  list(
    ...
    @Query() filters: FilterOccurrencesDto,
  ) {
  ...
  changeEstado(
    ...
    return this.occurrencesService.changeEstado(
      auditoriaId,
      id,
      dto,
  ...
  reprogram(
    ...
    return this.occurrencesService.reprogram(auditoriaId, id, dto, {
      userId: req.user.sub,
  ...
  editarFecha(
    ...
    return this.occurrencesService.editarFecha(auditoriaId, id, dto, {
      userId: req.user.sub,
      username: req.user.username,
    });
  }
  ...
  createAdHoc(
    ...
    return this.occurrencesService.createAdHoc(auditoriaId, dto, {
      userId: req.user.sub,
      username: req.user.username,
    });
  }
  ...
  remove(
    ...
    return this.occurrencesService.remove(auditoriaId, id, dto, {
      userId: req.user.sub,
      username: req.user.username,
    });
  }
