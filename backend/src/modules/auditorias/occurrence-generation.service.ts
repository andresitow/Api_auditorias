...
export class OccurrenceGenerationService {
  ...
  async generateYearForAuditoria(auditoriaId: string, anio: number) {
    ...
    return {
      anio,
      actividadesProcesadas: activities.length,
      periodosTotal,
      creadasTotal,
    };
  }
